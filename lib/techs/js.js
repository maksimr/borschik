...
exports.Tech = base.Tech.inherit({
    ...
    write: function(out, res) {
        return this.__base(out, res.join(''), {
            lines: res
        });
    },
        ...
        processInclude: function(baseFile, content) {
            ...
            for(var i = 0; i < parsed.length; i++) {
                ...
                if (typeof item === 'string') {
                    parsed[i] = new Object(item);
                    parsed[i].sourceLine = i;
                    parsed[i].sourceFile = this.path;
                    continue;
                }
            ...
            parsed = parsed.reduce(function(previousValue, currentValue) {
